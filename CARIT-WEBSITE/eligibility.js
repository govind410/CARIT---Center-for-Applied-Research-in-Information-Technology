...
function evaluateEligibility() {
    ...
    if (isEligible) {
        resultDiv.innerHTML = `Congratulations! Your average grade is ${averageGrade.toFixed(2)}. You meet the eligibility requirement for our student assistant positions. <a href="apply.html">Click here to apply</a>.`;
    } else {
